...
class SOAPWorkflowStageRequestUpdateObject
{
     ...
     */
    public function __construct($stage_id, $name, $deadline_days, $deadline_hours, $deadline_minutes, $start_trigger, $start_dependent_stage_id, $start_dependent_days, $start_dependent_hours, $start_dependent_minutes, $stage_locking, $stage_one_decision_only, $stage_private)
    {
    ...
    /**
     * @param int $stage_id
     * @return \Boskee\ProofHQ\SOAPWorkflowStageRequestUpdateObject
     */
