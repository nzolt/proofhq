...
class SOAPWorkflowProofStageRequestUpdateObject
{
     ...
     */
    public function __construct($stage_id, $name, $deadline_date, $deadline_time, $start_trigger, $start_dependent_stage_id, $start_dependent_date, $start_dependent_time, $stage_locking, $stage_one_decision_only, $stage_private, $deadline_calculate_on)
    {
    ...
    /**
     * @param int $stage_id
     * @return \Boskee\ProofHQ\SOAPWorkflowProofStageRequestUpdateObject
     */
