...
class SOAPProofStageObject
{
     ...
     */
    public function __construct($file_id, $stage_id, $name, $progress, $deadline_date, $start_trigger, $start_dependent_stage_id, $start_dependent_date, $stage_locking, $stage_one_decision_only, $stage_private, $comments_count, $recipients_count, $decision, $stage_start_date, $last_status_change_date, $active)
    {
    ...
    /**
     * @param int $file_id
     * @return \Boskee\ProofHQ\SOAPProofStageObject
     */
