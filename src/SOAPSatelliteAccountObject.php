...
class SOAPSatelliteAccountObject
{
     ...
     */
    public function __construct($id, $parent_account_id, $name, $membership, $users, $street, $city, $state, $postcode, $country, $telephone, $mobile, $fax, $domain, $password_settings, $proofing_defaults, $reference_id)
    {
      $this->id = $id;
    ...
    /**
     * @param int $id
     * @return \Boskee\ProofHQ\SOAPSatelliteAccountObject
     */
     ...
     * @return \Boskee\ProofHQ\SOAPSatelliteAccountObject
     */
    public function setParent_account_id($parent_account_id)
    {
      $this->parent_account_id = $parent_account_id;
      return $this;
    }
